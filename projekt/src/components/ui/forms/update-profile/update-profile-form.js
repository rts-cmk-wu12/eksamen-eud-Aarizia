...
export default async function updateProfileFormAction(prevState, formData) {
    ...
    const schema = z.object({
        ...
        passwordfirst: z.string().min(1, {message: 'Password field must be filled'}).max(50, {message: 'Password is too long. Max 50 characters'}),
        passwordsecond: z.string().min(1, {message: 'Repeat password field must be filled'}).max(50, {message: 'Repeat password is too long. Max 50 characters'}),
